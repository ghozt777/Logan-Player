    ...
    return (
        <Wrapper theme={theme}>
            <HeaderWrapper theme={theme} >
                <Icon src={liked} alt="history-icon" />
                <Header theme={theme} > Liked Videos </Header>
            </HeaderWrapper>
            {
                user&&user.likedVideos&&user.likedVideos.length>0 ? (
                    <Grid>
                        {
                            user.likedVideos.map((data,index) => 
